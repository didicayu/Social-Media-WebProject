...
SECRET_KEY = 'django-insecure-5kvs+^2vm-lich7gvrq1rr3t_!j_pm1u4-*s^9ppg=q38)g=g7'
...
STATIC_URL = 'static/'
STATIC_FILES_DIRS = [BASE_DIR / "static"]  # Add the static directory to the STATIC_FILES_DIRS list
